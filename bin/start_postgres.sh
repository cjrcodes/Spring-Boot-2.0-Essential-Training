...
mkdir -p "C:\Users\Christian Rodriguez\docker\volumes\postgres"
rm -rf "C:\Users\Christian Rodriguez\docker\volumes\postgres\data"

docker run --rm --name pg-docker -e POSTGRES_PASSWORD=postgres -e POSTGRES_DB=dev -d -p 5432:5432 -v "C:\Users\Christian Rodriguez\docker\volumes\postgres" postgres
